 ...
 * 학생(Student)클래스 정의
 * 필드 : #이름, #나이, #주소, 이모지
 * 메소드 : setter/gertter, display
 */

let dataList = [
    {name: '홍길동', age: 20, address: '서울시', emoji: '👤'},
    {name: '김철수', age: 21, address: '부산시', emoji: '🤦'},
    {name: '박영희', age: 22, address: '대전시', emoji: '🙅‍♀️'},
    {name: '박정민', age: 23, address: '대구시', emoji: '🤦‍♀️'},
    {name: '홍길순', age: 24, address: '강원시', emoji: '🙍‍♂️'}
];
...
//dataList의 학생벙보를 이용하여 objList를 생성
