...
/**
 * ProductDetail > Review > ReviewIop
 */
    ...
    return (
        <div className="review-list-item">
            <div className="pdt_review_info">
                <div className="product_review_info_eft">
            ...
            <ul className="pdt_review_photo">
                <li>
                    <img src="https://media.wconcept.co.kr/review/306388708/306388708_1753423555430.jpg?RS=300" alt="" />
                </li>
            </ul>
            <div >
            ...
            <div className="product_review_reaction">
                <div className="btn_report_item">
                    <button type="button"
                        className="btn_report_item_link_txt"
                    >
                        <span>신고</span>
                    </button>
                    <button type="button"
